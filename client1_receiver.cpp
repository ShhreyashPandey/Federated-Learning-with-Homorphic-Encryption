...
int main() {
    try {
        ...
        cout << "[Client1 Receiver] Using round " << round << endl;

        string url = "http://localhost:8000/result?round=" + to_string(round) + "&client_id=client1";
        ...
        cerr << "[Client1 Receiver] Error: " << e.what() << endl;
        cout << "-----------------------------------------------------\n";
        return 1;
    }
