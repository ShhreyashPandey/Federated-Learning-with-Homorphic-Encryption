...
int main() {
    try {
        ...
        if (!pkOut.is_open()) {
            std::cerr << "Unable to write client1 public key" << std::endl;
            return 1;
        }
        ...
        if (!skOut.is_open()) {
            std::cerr << "Unable to write client1 private key" << std::endl;
            return 1;
        }
        ...
        std::cerr << "Exception in client1_keygen: " << e.what() << std::endl;
        return 1;
    }
